...
public class two_obj_test {
  ...
  public static void main(String [] args) throws 
    ...
    fileHandler_ = new FileHandler("two_obj_test.log"); 
    ...
    pareto_nsgaII.printVariablesToFile("VAR_NSGAII_two");
    pareto_spea2.printVariablesToFile("VAR_SPEA2_two");
    pareto_ibea.printVariablesToFile("VAR_IBEA_two");
    pareto_total.printVariablesToFile("VAR_total_two");  
    
    logger_.info("Objectives values of Pareto Front have been writen to file FUN_*");
    pareto_nsgaII.printObjectivesToFile("FUN_NSGAII_two");
    pareto_spea2.printObjectivesToFile("FUN_SPEA2_two");
    pareto_ibea.printObjectivesToFile("FUN_IBEA_two");
    pareto_total.printObjectivesToFile("FUN_total_two");

    logger_.info("Objectives value of Total Population have been writen to file Pop_*");
    population_nsgaII.printObjectivesToFile("POP_NSGAII_two");
    population_spea2.printObjectivesToFile("POP_SPEA2_two");
    population_ibea.printObjectivesToFile("POP_IBEA_two");
    population_total.printObjectivesToFile("POP_total_two");
    
    indicators = new QualityIndicator(problem, "FUN_total_two") ; // file containing pareto front
